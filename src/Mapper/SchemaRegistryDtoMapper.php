...
namespace BlackCat\Database\Packages\SchemaRegistry\Mapper;

use BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto;
use BlackCat\Database\Packages\SchemaRegistry\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SchemaRegistryDto:
...
final class SchemaRegistryDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'applied_at' ];
    /** @var string[] */
     ...
     * @return SchemaRegistryDto
     */
    public static function fromRow(array $row): SchemaRegistryDto
    {
        /** @var SchemaRegistryDto */
        return DtoHydrator::fromRow(
            SchemaRegistryDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?SchemaRegistryDto
    {
     ...
     *
     * @param SchemaRegistryDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SchemaRegistryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SchemaRegistryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SchemaRegistryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SchemaRegistryDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SchemaRegistryDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SchemaRegistryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SchemaRegistryDto>
     */
