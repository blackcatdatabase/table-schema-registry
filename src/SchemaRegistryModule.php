...
final class SchemaRegistryModule implements ModuleInterface
{
    public function name(): string { return 'table-schema_registry'; }
    public function table(): string { return 'schema_registry'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_schema_component' ];
        if ($d->isMysql()) {
