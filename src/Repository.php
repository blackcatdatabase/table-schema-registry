...
use BlackCat\Database\Packages\SchemaRegistry\Repository\SchemaRegistryRepository;
...
{
    private SchemaRegistryRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SchemaRegistryRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto|null
    {
