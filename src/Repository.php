...
namespace BlackCat\Database\Packages\SchemaRegistry;
...
use BlackCat\Database\Packages\SchemaRegistry\Repository\SchemaRegistryRepository as GeneratedRepository;
...
{
  private SchemaRegistryRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SchemaRegistryRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SchemaRegistryRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SchemaRegistry\Dto\SchemaRegistryDto|null { return $this->repo->getById($id, $asDto); }
