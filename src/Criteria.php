...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'system_name', 'component', 'version', 'checksum', 'applied_at', 'meta' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'system_name', 'component', 'version', 'checksum' ];
    }

    /** Columns allowed in ORDER BY (falls back to filterable() when empty). */
    protected function sortable(): array
    {
        return [ 'id', 'system_name', 'component', 'version', 'checksum', 'applied_at' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SchemaRegistry\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SchemaRegistry\Definitions::softDeleteColumn();
