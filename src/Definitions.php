...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'schema_registry'; }
    public static function contractView(): string { return 'vw_schema_registry'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'system_name', 'component', 'version', 'checksum', 'applied_at', 'meta' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'system_name', 'component', 'version' ], [ 'id' ] ]; }
