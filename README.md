...
- Pkg folder: [packages\schema-registry](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\schema-registry)
...
graph LR
  ...
  schema_registry["schema_registry"]:::center
```
...
- `applied_at` – default=CURRENT_TIMESTAMP(6)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package schema-registry -Apply
