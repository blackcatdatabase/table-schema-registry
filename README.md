...
| Pkg folder | [packages/schema-registry](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/schema-registry) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package schema-registry -Apply
